...
dump_instruction(Instruction* inst)
{
    ...
    case INST_FAILURE:
        ...
        break;
    case INST_IN:
        printf("IN %lu", inst->u.in.dest->pos);
        break;
    case INST_JUMP:
        printf("JUMP %lu", inst->u.jump.dest->pos);
        break;
    case INST_LABEL:
        assert(FALSE);
        break;
    ...
    case INST_NEGATE:
        ...
        break;
    case INST_OFFSET:
        printf("OFFSET %04lu", inst->u.offset.dest->pos);
        break;
    case INST_RANGE:
        ...
        break;
    case INST_REPEAT:
        printf("REPEAT %04lu %5lu %5lu", inst->u.repeat.dest->pos, inst->u.repeat.min, inst->u.repeat.max);
        break;
    case INST_SUCCESS:
        printf("SUCCESS");
        break;
